...
const Home = () => {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col justify-center items-center bg-linear-to-b bg-gray-950 px-6 relative">
      <div className="flex flex-row items-center gap-4 justify-center">
        <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-gray-300 text-center">
          EcoMetric <span className="text-green-600">AI</span>
        </h1>

        <IoCarSport className="text-gray-400 text-8xl animate-pulse" />
      </div>

      <p className="mt-6 max-w-5xl text-center text-lg md:text-xl text-gray-400 leading-relaxed">
      ...
      <div className="mt-6 w-full  max-w-md flex flex-row justify-center gap-3">
        <button
          ...
          className={`w-70 h-[70px] rounded-2xl text-black font-medium transition bg-green-500 hover:bg-green-600`}
        >
          Get Start
        </button>
      </div>
